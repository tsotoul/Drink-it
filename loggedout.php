...
<div class="background2">
	<div class="login_result"><b><br/>You are currently logged out</b></div>
	<div class="login_result2"><br/>Feel free to browse through our products.</div>
	<div class="login_result2"><br/>Login as a member or as an administrator <a href="login.php" style="color:blue;">here</a></div>
</div> <!-- background2 -->
<div class="foot">
	<table class="footer">
	<tr>
