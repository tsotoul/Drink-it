...
<body>
<div class="menu">
	<div class="item"><a href="landingPage.hmtl" target="_self">Home</a></div>
	<div class="item"><a href="under_construction.html" target="_self">About</a></div>
	<div class="item"><a href="guidance.html" target="_self">How to/Guidance</a></div>
	<div class="item"><a href="under_construction.html" target="_self">Shop</a></div>
	<div class="item"><a href="under_construction.html" target="_self">Contact us</a></div>
	<div class="item"><input type="text" placeholder="Search..."></div>
</div> <!-- menu -->
<div class="background">
<a href="guidance.html"><img class="sticky" src="images/help.png" alt="help"></a>
